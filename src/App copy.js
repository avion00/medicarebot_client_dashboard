...
// ✅ ADD THIS: Simulate Loading Effect
const LoadingSkeleton = () => (
  <Box>
    {/* <Skeleton width={200} height={30} /> Simulated header */}
    <Skeleton width="99%"  height={"99%"} /> {/* Simulated page content */}
  </Box>
);
...
function App() {
  ...
  // ✅ Simulate initial loading effect (like YouTube)
  useEffect(() => {
    setLoading(true);
    const timer = setTimeout(() => setLoading(false), 1000); // Simulate API delay
    return () => clearTimeout(timer);
  }, [location.pathname]); // Re-run when navigating to a new page
