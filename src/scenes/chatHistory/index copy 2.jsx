      ...
      >
        ...
        >
          {[...Array(15)].map((_, index) => {
            // Generate a random gender and image index
            const gender = Math.random() > 0.5 ? "men" : "women";
            const imgIndex = Math.floor(Math.random() * 100); // random index from 0 to 99
            const imageUrl = `https://randomuser.me/api/portraits/${gender}/${imgIndex}.jpg`;
